  ...
  getProductInfo: (params) => {
    if (params === "") {
      ...
      return apiRequest.get(
        `/products?proCompany=${params.company}&proBigItem=${params.bigItem}&proKind=${params.kind}&proPeriod=${params.period}&proContent=${params.content}&proStatus=${params.status}`
      );
    }
  },
  //商品按讚
